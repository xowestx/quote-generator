...
class TermsEngineTests(unittest.TestCase):
    ...
    def test_roof_room_contract_period_and_conditional_approval(self):
        base_terms, _ = self.build(
            duration_months=5,
        ...
        self.assertNotIn("Maximum Contractual Period:", roof_terms)
        self.assertNotIn("two hundred twenty-five (225)", roof_terms)
